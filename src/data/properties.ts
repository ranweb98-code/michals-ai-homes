...
export const properties: Property[] = [
  ...
  },
  {
    ...
    size: 110,
    location: "אשדוד",
    address: "רובע יז׳, אשדוד",
    description: "דירה חדשה מקבלן ברובע חדש ומתפתח",
    longDescription: "דירת 4 חדרים חדשה מקבלן ברובע יז׳ החדש באשדוד. הדירה טרם אוכלסה וכוללת מפרט טכני גבוה, מטבח מודרני, מרפסת מרווחת ונוף פתוח. שכונה חדשה עם פארקים, בתי ספר ומרכז מסחרי. 2 חניות ומחסן.",
    image: "https://images.unsplash.com/photo-1600573472591-ee6981cf81d6?w=800",
    images: [
      "https://images.unsplash.com/photo-1600573472591-ee6981cf81d6?w=800",
      "https://images.unsplash.com/photo-1600566752355-35792bedcfea?w=800",
      "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?w=800",
    ],
    features: ["חדשה מקבלן", "מרפסת", "2 חניות", "מחסן", "מעלית"],
    isNew: true,
  },
  {
    id: "10",
